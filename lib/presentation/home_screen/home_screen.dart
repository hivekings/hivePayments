    ...
    return SafeArea(
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: AppbarTitle(
                    text: "msg_welcome_back_alicia".tr,
                ...
                actions: [
                  AppbarImage(
                      ...
                      margin:
                          getMargin(left: 24, top: 4, right: 24, bottom: 18))
                ]),
            body: Container(
                width: size.width,
                height: size.height,
                    ...
                    child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                  padding:
                                      getPadding(left: 2, top: 34, right: 24),
                                  child: Row(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        Padding(
                                            ...
                                            child: Text("lbl_last_movements".tr,
                                                overflow: TextOverflow.ellipsis,
                                                textAlign: TextAlign.left,
                                                style:
                              ...
                              Padding(
                                  ...
                                  child: Obx(() => ListView.separated(
                                      ...
                                      itemCount: controller.homeModelObj.value
                                          .listellipsenineItemList.length,
                                      itemBuilder: (context, index) {
